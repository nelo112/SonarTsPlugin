...
public class TsRulesDefinition implements RulesDefinition {
    ...
    public static final String RULE_PARAM_STATEMENTS = "statements";
    ...
    public static final String RULE_PARAM_AVOID_ESCAPE = "avoid-escape";
    public static final String RULE_RADIX = "radix";
    public static final String RULE_SEMICOLON = "semicolon";
    public static final String RULE_SORT_OBJECT_LITERAL_KEYS = "sort-object-literal-keys";
    ...
    public static final String RULE_PARAM_ALLOW_TRAILING_UNDERSCORE = "allow-trailing-underscore";
    ...
    public void define(Context context) {
        ...
        repository.createRule(RULE_NO_CONDITIONAL_ASSIGNMENT).setName("Disallows any type of assignment in any conditionals. this applies to do-while, for, if, and while statements").setSeverity(Severity.MAJOR);
        ...
        repository.createRule(RULE_NO_INTERNAL_MODULE).setName("Disallows internal module, use namespace instead").setSeverity(Severity.MAJOR);
        repository.createRule(RULE_NO_REQUIRE_IMPORTS).setName("Disallows require() style imports").setSeverity(Severity.MAJOR);
        ...
        repository.createRule(RULE_SORT_OBJECT_LITERAL_KEYS).setName("Checks that keys in object literals are declared in alphabetical order").setSeverity(Severity.MAJOR);
